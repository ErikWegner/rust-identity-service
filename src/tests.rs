...
fn login_returns_url() {
    ...
    assert_eq!(response.headers().get_one("Location"), Some("https://my.real.auth/auth/login?response_type=code&client_id=b4b3fbf2-f65e-40b5-b449-4b9825382140&redirect_uri=https%3A%2F%2Ffront.end.server%2Fauth%2Fcallback&scope=openid"));
}
